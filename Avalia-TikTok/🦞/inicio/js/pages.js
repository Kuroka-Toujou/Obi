...
document.addEventListener("DOMContentLoaded", function() {
  ...
  video.play().then(() => {
    video.muted = false; // tenta habilitar o som
  }).catch(err => {
    console.log("O navegador bloqueou o autoplay com som:", err);
  });
});
</script>
...
function setupVideoPage() {
  document.querySelector('.unlock-btn').addEventListener('click', () => {
    window.location.href = 'https://pay.transacaomarketplace.com/checkout/856068de-7cfc-4139-b6c5-e5b13181a988';
  });
